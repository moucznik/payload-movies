...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_content_columns_link_type" AS ENUM('pestreference', 'custom');
  ...
  CREATE TYPE "public"."enum_movies_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__movies_v_version_status" AS ENUM('draft', 'published');
  ...
  CREATE TABLE IF NOT EXISTS "movies_populated_authors" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar
  ...
  CREATE TABLE IF NOT EXISTS "movies" (
  	...
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"_status" "enum_movies_status" DEFAULT 'draft'
  );
  
  CREATE TABLE IF NOT EXISTS "movies_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_movies_v_version_populated_authors" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_uuid" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_movies_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  	"version_title" varchar,
  	"version_content" jsonb,
  	...
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  	"version__status" "enum__movies_v_version_status" DEFAULT 'draft',
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"latest" boolean,
  	"autosave" boolean
  ...
  CREATE TABLE IF NOT EXISTS "_movies_v_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "movies_populated_authors" ADD CONSTRAINT "movies_populated_authors_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."movies"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "movies" ADD CONSTRAINT "movies_meta_image_id_media_id_fk" FOREIGN KEY ("meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "movies_rels" ADD CONSTRAINT "movies_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."movies"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "movies_rels" ADD CONSTRAINT "movies_rels_movies_fk" FOREIGN KEY ("movies_id") REFERENCES "public"."movies"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "movies_rels" ADD CONSTRAINT "movies_rels_categories_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "movies_rels" ADD CONSTRAINT "movies_rels_users_fk" FOREIGN KEY ("users_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_movies_v_version_populated_authors" ADD CONSTRAINT "_movies_v_version_populated_authors_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_movies_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_movies_v" ADD CONSTRAINT "_movies_v_parent_id_movies_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."movies"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_movies_v" ADD CONSTRAINT "_movies_v_version_meta_image_id_media_id_fk" FOREIGN KEY ("version_meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_movies_v_rels" ADD CONSTRAINT "_movies_v_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."_movies_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_movies_v_rels" ADD CONSTRAINT "_movies_v_rels_movies_fk" FOREIGN KEY ("movies_id") REFERENCES "public"."movies"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_movies_v_rels" ADD CONSTRAINT "_movies_v_rels_categories_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_movies_v_rels" ADD CONSTRAINT "_movies_v_rels_users_fk" FOREIGN KEY ("users_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "redirects_rels" ADD CONSTRAINT "redirects_rels_movies_fk" FOREIGN KEY ("movies_id") REFERENCES "public"."movies"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "movies_populated_authors_order_idx" ON "movies_populated_authors" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "movies_populated_authors_parent_id_idx" ON "movies_populated_authors" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "movies_meta_meta_image_idx" ON "movies" USING btree ("meta_image_id");
  CREATE INDEX IF NOT EXISTS "movies_slug_idx" ON "movies" USING btree ("slug");
  CREATE INDEX IF NOT EXISTS "movies_created_at_idx" ON "movies" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "movies__status_idx" ON "movies" USING btree ("_status");
  CREATE INDEX IF NOT EXISTS "movies_rels_order_idx" ON "movies_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "movies_rels_parent_idx" ON "movies_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "movies_rels_path_idx" ON "movies_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "movies_rels_movies_id_idx" ON "movies_rels" USING btree ("movies_id");
  CREATE INDEX IF NOT EXISTS "movies_rels_categories_id_idx" ON "movies_rels" USING btree ("categories_id");
  CREATE INDEX IF NOT EXISTS "movies_rels_users_id_idx" ON "movies_rels" USING btree ("users_id");
  CREATE INDEX IF NOT EXISTS "_movies_v_version_populated_authors_order_idx" ON "_movies_v_version_populated_authors" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_movies_v_version_populated_authors_parent_id_idx" ON "_movies_v_version_populated_authors" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_movies_v_parent_idx" ON "_movies_v" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_movies_v_version_meta_version_meta_image_idx" ON "_movies_v" USING btree ("version_meta_image_id");
  CREATE INDEX IF NOT EXISTS "_movies_v_version_version_slug_idx" ON "_movies_v" USING btree ("version_slug");
  CREATE INDEX IF NOT EXISTS "_movies_v_version_version_created_at_idx" ON "_movies_v" USING btree ("version_created_at");
  CREATE INDEX IF NOT EXISTS "_movies_v_version_version__status_idx" ON "_movies_v" USING btree ("version__status");
  CREATE INDEX IF NOT EXISTS "_movies_v_created_at_idx" ON "_movies_v" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "_movies_v_updated_at_idx" ON "_movies_v" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "_movies_v_latest_idx" ON "_movies_v" USING btree ("latest");
  CREATE INDEX IF NOT EXISTS "_movies_v_autosave_idx" ON "_movies_v" USING btree ("autosave");
  CREATE INDEX IF NOT EXISTS "_movies_v_rels_order_idx" ON "_movies_v_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "_movies_v_rels_parent_idx" ON "_movies_v_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_movies_v_rels_path_idx" ON "_movies_v_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "_movies_v_rels_movies_id_idx" ON "_movies_v_rels" USING btree ("movies_id");
  CREATE INDEX IF NOT EXISTS "_movies_v_rels_categories_id_idx" ON "_movies_v_rels" USING btree ("categories_id");
  CREATE INDEX IF NOT EXISTS "_movies_v_rels_users_id_idx" ON "_movies_v_rels" USING btree ("users_id");
  ...
  CREATE INDEX IF NOT EXISTS "redirects_rels_movies_id_idx" ON "redirects_rels" USING btree ("movies_id");
...
export async function down({ payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "users";
  DROP TABLE "movies_populated_authors";
  DROP TABLE "movies";
  DROP TABLE "movies_rels";
  DROP TABLE "_movies_v_version_populated_authors";
  DROP TABLE "_movies_v";
  DROP TABLE "_movies_v_rels";
  ...
  DROP TYPE "public"."enum_movies_status";
  DROP TYPE "public"."enum__movies_v_version_status";
